      ...
      container.selectAll(".planet").each(function(d) {
        ...
        if (clip(pos)) {
          ...
          if (cfg.planets.symbolType === "letter") {
            ...
            //setTextStyle(cfg.constellations.namestyle.font);
            context.font = "0.5em Centaur, serif";
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('Mercury', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
            ...
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('Venus', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
            ...
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('earth', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
            ...
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('Mars', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
            ...
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('Jupiter', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
            ...
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('Saturn', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
            ...
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('Uranus', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
            ...
            context.fillStyle = sym.fill;
            context.textAlign = "center";
            context.fillText('Neptune', pt[0]/0.65, pt[1]/0.65 - 4);
            context.restore();
...
function exportSVG(fname, starMapTitle, starMapNames, starMapDate, starMapLocation) {
  ...
  svg.attr("width", m.width * 0.75).attr("height", m.height * 1.3);
  ...
  var getWatermark = document.getElementById('watermark').innerHTML;
  ...
  if ( getWatermark == "Yes") {
    ...
    .attr("font-size", "5.75em")
    .attr("fill", "#ffffff")
    //.attr("text-anchor", "middle")
    .attr('transform', 'rotate(90)')
    .attr("fill-opacity","0.2")
    .attr("style", "text-transform: uppercase; font-family: futura; font-weight: 600;");
  }

  var starMapTitle = document.getElementById('starMapTitle').innerHTML;
  var starMapNames = document.getElementById('starMapNames').innerHTML;
  var starMapDate = document.getElementById('starMapDate').innerHTML;
  var starMapLocation = document.getElementById('starMapLocation').innerHTML;

  var starMapTitleColour = document.getElementById('starMapTitle').style.color;
  var starMapNamesColour = document.getElementById('starMapNames').style.color;
  var starMapDateColour = document.getElementById('starMapDate').style.color;
  var starMapLocationColour = document.getElementById('starMapLocation').style.color;

  svg.append("text")
                  .attr("id", "starMapTitle")
                  .attr("x", "50%")
                  .attr("y", "90.5%")
                  .text( starMapTitle )
                  .attr("font-family", "FuturaPT-Bold")
                  .attr("font-size", "1.8em")
                  .attr("fill", starMapTitleColour)
                  .attr("text-anchor", "middle")
                  .attr("style", "text-transform: uppercase; font-family: FuturaPT-Bold; font-weight: 600;");
                
                  svg.append("text")
                  .attr("id", "starMapNames")
                  .attr("x", "50%")
                  .attr("y", "93.5%")
                  .text( starMapNames )
                  .attr("font-family", "Futura")
                  .attr("font-size", "1.4em")
                  .attr("fill", starMapNamesColour)
                  .attr("text-anchor", "middle")
                  ...
                  .attr("font-family", "Futura")
                  .attr("font-size", "1.4em")
                  .attr("fill", starMapDateColour)
                  .attr("text-anchor", "middle")
                  .attr("style", "text-transform: uppercase;");
                
                  svg.append("text")
                  .attr("id", "starMapLocation")
                  .attr("x", "50%")
                  .attr("y", "99.5%")
                  .text( starMapLocation )
                  .attr("font-family", "Futura")
                  .attr("font-size", "1.4em")
                  .attr("fill", starMapLocationColour)
                  .attr("text-anchor", "middle")
                  .attr("style", "text-transform: uppercase;");
...
*/  
  ...
  if (cfg.stars.show) { 
    q.defer(function(callback) { 
      d3.json(path +  cfg.stars.data, function(error, json) {
        ...
        callback(null);
        /*var countStars = groups.stars.selectAll(".stars").data(cons.features.filter( function(d) { return d.properties.mag <= cfg.stars.limit; })).enter().append("path").attr("class", function(d) { return "stars" + starColor(d.properties.bv); }).attr("d", map.pointRadius( function(d) { return d.properties ? starSize(d.properties.mag) : 1; })).size();
    ...
    q.defer(function(callback) {
      ...
      //if (cfg.planets.names) {
        groups.planetNames.selectAll(".planetnames")
         ...
         .enter().append("text")
         .attr("transform", function(d) { return point(d.geometry.coordinates); })
         .text( function(d) { if (d.properties.name == "Mer") { return "Mercury"}; if (d.properties.name == "Ven") { return "Venus"}; if (d.properties.name == "Ter") { return "Earth"}; if (d.properties.name == "Mar") { return "Mars"}; if (d.properties.name == "Sat") { return "Saturn"}; if (d.properties.name == "Jup") { return "Jupiter"}; if (d.properties.name == "Ura") { return "Uranus"}; if (d.properties.name == "Nep") { return "Neptune"}; })
        ...
        if (jlun.features.length > 0) {
          groups.planetNames.selectAll(".moonname")
           ...
           .enter().append("text")
           .attr("transform", function(d) { return point(d.geometry.coordinates); })
           .text( function(d) { /*return d.properties.name;*/ return "" })
           .attr({dy: ".85em", dx: "-.35em"})
           .attr("class", function(d) { return "planetNames " + d.id; });
        }
      //}
  ...
  q.await(function(error) {
    var getBackgroundColour = document.body.style.color;
    ...
    var svg = d3.select("#d3-celestial-svg svg")
      ...
      .attr("viewBox", " 0 0 " + (m.width) + " " + (m.height * 1.35))
      .attr("style", "margin-left: auto; margin-right: auto;")
      .attr("style", "background-color:" + getBackgroundColour);
    ...
    if (fname) {
      /*var dataURI = 'data:image/svg+xml; charset=utf8, ' + encodeURIComponent(svg.node().outerHTML);*/
      //var blob = new Blob([svg.node().outerHTML], {type:"image/svg+xml;charset=utf-8"});
      document.body.innerHTML = svg.node().outerHTML;
      ...
      var decodedTitle = starMapTitle.replace(/&amp;/g, '&')
      var decodedNames = starMapNames.replace(/&amp;/g, '&')
      var decodedDate = starMapDate.replace(/&amp;/g, '&')
      var decodedLocation = starMapLocation.replace(/&amp;/g, '&')

      document.getElementById('starMapTitle').innerHTML = decodedTitle;
      document.getElementById('starMapNames').innerHTML = decodedNames;
      document.getElementById('starMapDate').innerHTML = decodedDate;
      document.getElementById('starMapLocation').innerHTML = decodedLocation;

      document.querySelector('svg').style.width = "100%";

      //var pdfSize = document.getElementById('starMapSize').innerHTML;

      //if ( pdfSize == "2X2") {

        //document.querySelector('svg').style.marginTop = "10%";

      //} else {

      document.querySelector('svg').style.marginTop = "17.25%";

      //}

      document.documentElement.style.height ="88%";

      /*var img = document.createElement('img');
      img.style.width = '90%';
      img.style.marginLeft = '4.5%';
